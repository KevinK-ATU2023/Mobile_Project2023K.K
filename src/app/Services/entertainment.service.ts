...
export class EntertainmentService {
  ...
  search_movies():Observable<any> {
    return this.http.get(`${environment.base_url}/search/movie?api_key=${environment.api_key}&language=en-US&page=1&include_adult=false`);
  }
